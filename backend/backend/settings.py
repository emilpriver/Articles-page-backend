...
if not DEBUG:
    ...
    AWS_BUCKET_REGION = os.getenv('AWS_STORAGE_BUCKET_REGION')
    AWS_S3_CUSTOM_DOMAIN = f'd2335h78559og4.cloudfront.net'
    ...
    STATICFILES_STORAGE = 'backend.aws.storage_backends.StaticStorage'
